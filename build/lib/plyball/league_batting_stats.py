...
def sanitize_input(start_dt, end_dt):
    ...
    if start_dt is None and end_dt is None:
        ...
        print("Warning: no date range supplied. Returning yesterday's data. For a different date range, "
              "try batting_stats_range(start_dt, end_dt) or batting_stats(season).")
